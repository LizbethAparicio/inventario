...
function validaform3(){//consulta clientes
	...
	if (document.form3.criterios.value.length==0 && document.form3.criterios.value.length=='Usuario'){
		alert(errorMessage);
...
function excelp(){
	...
	var msg=confirm("Esta seguro de generar el archivo de excel");
	if(msg){
		form3.action="excelprovedor.php";
		form3.submit ( );	
	}
}
function excelpro(){
	...
	var msg=confirm("Esta seguro de generar el archivo de excel");
	if(msg){
		form3.action="excelproductos.php";
		form3.submit ( );	
	}
}
...
function excelent(){
	...
	var msg=confirm("Esta seguro de generar el archivo de excel");
	if(msg){
		form3.action="excelentradas.php";
		form3.submit ( );	
	}
}
function word(){
...
function wordpro(){
	...
	var msg1=confirm("Esta seguro de generar el archivo de word");
	if(msg1){
		form3.action="wordproductos.php";
		form3.submit ( );	
	}
}
